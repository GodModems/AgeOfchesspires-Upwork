...
#region Private Methods
        ...
        public override void Spawned()
        {
            ...
            NetworkRunner networkRunner = this.Runner;
            Debug.Log(networkRunner != null ? "NeworkRunner Found!" : "NeworkRunner Not Found!");


            this.voiceConnection = networkRunner.GetComponent<VoiceConnection>();
            Debug.Log(this.voiceConnection != null ? "Voice Conn Found!" : "Voice Conn Not Found!");
